...
(async () => {
    for (let email of emails) {
        ...
        await page.waitForSelector('input[name="new-password"]', { visible: true });
        await page.type('input[name="new-password"]', 'SPOTIFY12345', { delay: 100 });
        ...
        await page.click('input[name="gender"][value="male"]'); // Select gender

        // Step 7: Finalize the registration
        await page.waitForSelector('button[data-testid="submit"]', { visible: true });
        await page.click('button[data-testid="submit"]');
        ...
        await browser.close(); // Close the browser after each registration
